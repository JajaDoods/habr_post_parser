...
class Article:
    ...
    def __extract_publicatoin_date_info(self) -> None:
        '''
    ...
    def __extract_author_info(self) -> None:
        '''
    ...
    def __extract_article_info(self) -> None:
        '''
    ...
    def __extract_bookmarks_info(self) -> None:
        '''
    ...
    def __extract_comments_info(self) -> None:
        '''
    ...
    def get_info(self) -> Dict[str, str]:
        self.__extract_publicatoin_date_info()
        self.__extract_author_info()
        self.__extract_article_info()
        self.__extract_views_info()
        self.__extract_voices_info()
        self.__extract_bookmarks_info()
        self.__extract_comments_info()
